...
const DEFAULT_ACCEPTED_TYPES = ['application/pdf', 'image/jpeg', 'image/png', 'image/gif'];
...
export const MediaUploader = ({
    ...
    uploadUrl = 'http://localhost:3000/media/upload',
    ...
    const onDrop = useCallback(async (acceptedFiles) => {
        ...
        try {
            ...
            // onUploadSuccess({ attachmentId, fileName });
        ...
        <FormControl isInvalid={!!error}>
            <VStack spacing={4} align="stretch">
                <Box
                    ...
                    borderRadius="md"
                    borderStyle="dashed"
                    borderColor={isDragActive ? 'blue.500' : error ? 'red.500' : 'gray.200'}
